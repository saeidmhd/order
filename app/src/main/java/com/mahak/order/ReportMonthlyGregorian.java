...
public class ReportMonthlyGregorian extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                setMonthTitle();
                FillArrayMonthlyOrder(ReportType, cal.get(Calendar.YEAR), cal.get(Calendar.MONTH), cal.get(Calendar.DAY_OF_MONTH));
            }
        });
    ...
    private void setMonthTitle() {
        String strDate = "";
        strDate = ServiceTools.getMonthNameForInt(cal.get(Calendar.MONTH)) + " " + cal.get(Calendar.YEAR);
    ...
    private void FillArrayMonthlyOrder(int reporttype, int y, int m, int d) {
        ...
        do {
            ...
            instance.set(calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH));
            instance.set(Calendar.HOUR_OF_DAY, 0);
            instance.set(Calendar.MINUTE, 0);
            instance.set(Calendar.SECOND, 0);
            instance.set(Calendar.MILLISECOND, 0);
            /////////////////////////////////////
            DayName = calendar.get(Calendar.DAY_OF_MONTH) + " " + ServiceTools.getWeekDayForInt(instance.get(Calendar.DAY_OF_WEEK));
