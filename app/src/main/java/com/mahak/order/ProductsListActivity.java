...
public class ProductsListActivity extends BaseActivity {
    ...
    public void getProducts() {
        asyproduct = new AsynProduct(CategoryId, PAGE_STATE, MODE_ASSET);
        asyproduct.execute();
    }
...
//            gvProduct = (GridView) rootView.findViewById(R.id.gvProduct);
    ...
    public class AsynProduct extends AsyncTask<String, String, Boolean> {
        ...
        public AsynProduct(long id, int statepage, int modeasset) {
        ...
        protected Boolean doInBackground(String... arg0) {
            ...
            arrayProductMain = db.getAllProduct(0,Id, ModeAssetProduct, 0);
