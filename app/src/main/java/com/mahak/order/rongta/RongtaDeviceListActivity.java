package com.mahak.order.rongta;
 ...
 */
public class RongtaDeviceListActivity extends Activity {
    // Debugging
    private static final String TAG = "RongtaDeviceListActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (pairedDevices.size() > 0) {
            ...
            for (BluetoothDevice device : pairedDevices) {
                if (device.getName().toLowerCase().startsWith("rpp"))
    ...
    private void permissionChecking() {
        ...
        if (CURRENT_ANDROID_VERSION >= Build.VERSION_CODES.M) { //Marshmallow
            ...
            if (ContextCompat.checkSelfPermission(RongtaDeviceListActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION)
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(RongtaDeviceListActivity.this,
                    ...
                    alertDialogBuilder
                            ...
                            .setPositiveButton("Allow", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    ActivityCompat.requestPermissions(RongtaDeviceListActivity.this,
        ...
        switch (requestCode) {
            case PERMISSIONS_REQUEST_LOCATION: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(RongtaDeviceListActivity.this, "Permission is Denied!", Toast.LENGTH_LONG).show();
                }
                return;
            }
    ...
    public List<String> getPairedData() {
        ...
        if (pairedDevices.size() > 0) {
            findViewById(R.id.title_paired_devices).setVisibility(View.VISIBLE);
            for (BluetoothDevice device : pairedDevices) {
                if (device.getName().toLowerCase().startsWith("rpp")) //filter just hprt printer devices
