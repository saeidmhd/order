...
public class TransferPagerAdapter extends FragmentPagerAdapter {
    ...
    public TransferPagerAdapter(Context context, FragmentManager fm) {
        super(fm);
    ...
    public CharSequence getPageTitle(int position) {
        switch (position) {
            case 0:
                return context.getString(R.string.str_transfer_goods);
            case 1:
                return context.getString(R.string.str_transfer_spec);
            default:
                return null;
        }
    }
