...
public class FontButtonView extends androidx.appcompat.widget.AppCompatButton {
    ...
    public FontButtonView(Context context, AttributeSet attrs, int defStyleAttr) {
