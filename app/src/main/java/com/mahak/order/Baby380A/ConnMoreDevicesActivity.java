...
import static com.mahak.order.Baby380A.Constant.ACTION_USB_PERMISSION;
import static com.mahak.order.Baby380A.Constant.CONN_STATE_DISCONN;
import static com.mahak.order.Baby380A.Constant.MESSAGE_UPDATE_PARAMETER;
import static com.mahak.order.Baby380A.DeviceConnFactoryManager.CONN_STATE_FAILED;
import static com.mahak.order.Baby380A.ListViewAdapter.CONN_METHOD;
import static com.mahak.order.Baby380A.ListViewAdapter.MESSAGE_CONNECT;
            ...
            switch (msg.what) {
                case MESSAGE_CONNECT:
                    ...
                    if (deviceConnFactoryManagers[id] == null) {
                        Toast.makeText(ConnMoreDevicesActivity.this, "لطفا ابتدا پورت و آدرس را تنظیم کنید", Toast.LENGTH_SHORT).show();
                        return;
                    }
